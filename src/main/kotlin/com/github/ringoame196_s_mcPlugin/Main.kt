...
class Main : JavaPlugin() {
    ...
    override fun onDisable() {
        super.onDisable()
        discordWebHookManager.sendDiscordWebhook(":red_circle: サーバー停止しました", "サーバー", "https://p1.hiclipart.com/preview/896/990/447/minecraft-hd-icon-mac-pc-minecraft-icon-512-png-icon.jpg")
    }
}
